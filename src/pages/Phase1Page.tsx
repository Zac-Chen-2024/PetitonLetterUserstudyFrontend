    ...
    <div className="flex flex-col h-full">
      ...
      <div className="fixed bottom-3 left-3 z-50 flex gap-1">
        <button
          ...
          className="px-2 py-1 text-[10px] bg-red-500 text-white rounded opacity-60 hover:opacity-100"
        >
          DEV → P2
        </button>
        <button
          onClick={devSkipToPhase3}
          className="px-2 py-1 text-[10px] bg-purple-500 text-white rounded opacity-60 hover:opacity-100"
        >
          DEV → P3
        </button>
      </div>
